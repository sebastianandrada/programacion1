...
int main()
{
    ...
    initVentas(ventas, CANT_VENTAS, 1);

    cargaForzadaCliente(clientes, CANT_CLIENTES, "Juan", "Gigg", 1234568); //id: 0
    cargaForzadaCliente(clientes, CANT_CLIENTES, "Maria", "Alvarez", 1234447); //id:1
    cargaForzadaCliente(clientes, CANT_CLIENTES, "Daniela", "Suarez", 123488); //id: 2

    cargaForzadaVenta(ventas, CANT_VENTAS, 0, 4000, "afiche0.jpg",  0, 1);
    cargaForzadaVenta(ventas, CANT_VENTAS, 1, 3000, "afiche1.jpg",  1, 0);
    cargaForzadaVenta(ventas, CANT_VENTAS, 1, 200, "afiche6",       0, 0);
    cargaForzadaVenta(ventas, CANT_VENTAS, 2, 300, "afiche2.jpg",   2, 1);
    cargaForzadaVenta(ventas, CANT_VENTAS, 2, 45, "afiche3.jpg",    0, 1);
    cargaForzadaVenta(ventas, CANT_VENTAS, 2, 200, "afiche4",       0, 1);
    cargaForzadaVenta(ventas, CANT_VENTAS, 2, 100, "afiche4",       0, 0);
    ...
    do
    {
        ...
        switch (opcion)
        {
            ...
            case 7:
                ...
                break;
            case 8:
                mostrarInforme(clientes, CANT_CLIENTES, ventas, CANT_VENTAS);
                break;
        }
    } while(opcion != 0);
